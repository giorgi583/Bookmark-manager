...
console.log(copiedId)
  return (
    <li key={bookmark._id} className="p-4 bg-taupe-600/20 rounded-2xl grid grid-cols-[auto_1fr_auto] gap-5 items-center z-10 justify-between relative group/outer">
    ...
    <div className="flex gap-2">
      ...
      <div className='cursor-pointer p-2 rounded-2xl flex items-center gap-5' ><button className="cursor-pointer group/inner relative" onClick={() => handleToggleFavorite(bookmark._id)}>
